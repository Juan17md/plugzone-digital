...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    icons: [
      {
        src: 'https://ik.imagekit.io/h5w0cdkit/plugzone/icono_sin_fondo_e9DNtxsHd.PNG?tr=p-25p,w-192,h-192,cm-pad_resize,bg-080C14',
        sizes: '192x192',
        type: 'image/png',
        purpose: 'any',
      },
      {
        src: 'https://ik.imagekit.io/h5w0cdkit/plugzone/icono_sin_fondo_e9DNtxsHd.PNG?tr=p-25p,w-512,h-512,cm-pad_resize,bg-080C14',
        sizes: '512x512',
        type: 'image/png',
        purpose: 'any',
      },
